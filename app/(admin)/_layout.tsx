  ...
  return (
    <View style={styles.container}>
      ...
      <Tabs.Screen
        ...
        options={{
          title: "Users",
          href: canManageUsers ? "/users" : null,
          tabBarIcon: ({ color, focused }) => (
            <View style={focused ? styles.activeIconContainer : undefined}>
      ...
      <Tabs.Screen
        ...
        options={{
          title: "Insights",
          href: canManageUsers ? "/insights" : null,
          tabBarIcon: ({ color, focused }) => (
            <View style={focused ? styles.activeIconContainer : undefined}>
      ...
      />
      <Tabs.Screen
        name="register-sebayat"
        options={{
          href: null,
        }}
      />
      <Tabs.Screen
        name="sebayat-reports"
        options={{
          href: null,
        }}
      />
      ...
      />
      <Tabs.Screen
        name="user-history/[id]"
        options={{
          href: null,
        }}
      />
      <Tabs.Screen
        name="all-sebayat-data"
        options={{
          href: null,
        }}
      />
      <Tabs.Screen
        name="my-darshan-tickets"
        options={{
          href: null,
        }}
      />
      <Tabs.Screen
        name="sebayat-tickets"
        options={{
          href: null,
        }}
      />
